...
Rule:privilages for user auttoemp1
  ...
  Scenario: Check user can't add past reservations or change min rate
    ...
    And fill Reservation Data with Source "RANDOM" purpose "RANDOM" Unit "RANDOM" Guest "RANDOM" startDate "02/01/2021" endDate "03/01/2021"
    ...
    Scenario: can't Cehcek in future reservations
      When Click on Add new Reservation
      And fill Reservation Data with Source "RANDOM" purpose "RANDOM" Unit "RANDOM" Guest "RANDOM" startDate "02/01/2030" endDate "03/01/2030"
  ...
  Background: selecting property
    ...
    Scenario: can't change from date of checkedin reservation to future
      ...
      Scenario:late check out
        Given  Create "Checked In" Reservation withSource "RANDOM" purpose "RANDOM" Unit "RANDOM" Guest "RANDOM" startDate "01/12/2021" endDate "03/12/2021"

...
Feature: Guest Feature
  ...
  Rule:Guests selection popup
    Background:open New Reservation Page
  ...
  Rule: Guests Page
    ...
    Scenario Outline: edit  guest details
      ...
      Examples:
        ...
        | 5565872 | Zaky  | Zeko2 | 236548795 | Unknown | any   | National Id | 65549   |          |     |                       | Inserted Id was used before for other guest number                                                                                                                                                                                                                                  |

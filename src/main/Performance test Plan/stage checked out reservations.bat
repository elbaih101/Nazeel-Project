...
set jmxFile=F:\java maven projects\Nazeel-Project\src\main\Performance test Plan\Reservations full Cycle.jmx
...
call jmeter -n  -t "%jmxFile%" -l "%csvLog%" -j "%runLog%" -e -o "%dashBoard%" %distributed%
ECHO test completed